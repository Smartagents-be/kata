 ...
 * would reach. Step 1 has its own {@code Scramble}; this is step 2's copy, on purpose, because a
 * step owns its own grading code rather than reaching across into another step's.
 *
