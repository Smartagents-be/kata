 ...
 * them: your language and whether the notes show. A reset takes the first kind only, so a room of
 * machines can be handed to the next group without anyone setting the language again.
 *
 ...
 * that must survive a reset needs a key outside it, the way `kata.mode` does.
 */
